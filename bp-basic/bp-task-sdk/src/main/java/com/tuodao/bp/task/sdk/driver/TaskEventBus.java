package com.tuodao.bp.task.sdk.driver;
...
public class TaskEventBus {
	...
	/** 日志 */
	private static final org.slf4j.Logger logger = LoggerFactory.getLogger(TaskEventBus.class);
	...
	public void post(PostEvent postEvent) {
		...
		if (eventSubscribers.hasNext()) {
			...
			logger.error("有其它监听者去处理此事，我先不管-taskId：[{}]",postEvent.getTaskId());
		}
	}
