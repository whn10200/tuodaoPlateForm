...
public class EnableRedisCacheAutoConfiguration extends CachingConfigurerSupport {
	...
	@Bean
	public ConfigDictionaryCache configDictionaryCache() {
		return new ConfigDictionaryCache();
	}

	@Bean
	public MsgTempCache msgTempCache() {
		return new MsgTempCache();
	}

	@Bean
	public AccountBankCache accountBankCache() {
		return new AccountBankCache();
	}
	...
	public CacheManager cacheManagerAccess(RedisTemplate bpRedisTemplate) {
	 ...
	 * @return
	 */
	@Bean(name = "cacheManagerTenMinute")
	 ...
	 * @return
	 */
	@Bean(name = "cacheManagerAccessApp")
	public CacheManager cacheManagerAccessApp(RedisTemplate bpRedisTemplate) {
